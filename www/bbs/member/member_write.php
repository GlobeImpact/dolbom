    ...
    <form id="fregisterform" name="fregisterform" action="" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="layer_popup_form">
            ...
            <div class="form_flex mtop20">
                ...
                <?/*
                <div class="div_area">
                    <h4 class="layer_popup_tit mtop_20">제공인력 교육정보</h4>

                    <table class="write_tbl">
                        <thead>
                            <tr>
                                <th class="x80">교육</th>
                                <th class="x125">시작일</th>
                                <th class="x125">종료일</th>
                                <th>교육시간</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th>기본</th>
                                <td>
                                    <input type="text" name="training_str_date1" id="training_str_date1" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_str_date1'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_end_date1" id="training_end_date1" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_end_date1'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_time1" id="training_time1" class="form_input xp100" value="<?php echo $write['training_time1'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>심화</th>
                                <td>
                                    <input type="text" name="training_str_date2" id="training_str_date2" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_str_date2'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_end_date2" id="training_end_date2" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_end_date2'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_time2" id="training_time2" class="form_input xp100" value="<?php echo $write['training_time2'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>경력자</th>
                                <td>
                                    <input type="text" name="training_str_date3" id="training_str_date3" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_str_date3'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_end_date3" id="training_end_date3" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_end_date3'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_time3" id="training_time3" class="form_input xp100" value="<?php echo $write['training_time3'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>보수</th>
                                <td>
                                    <input type="text" name="training_str_date4" id="training_str_date4" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_str_date4'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_end_date4" id="training_end_date4" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_end_date4'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_time4" id="training_time4" class="form_input xp100" value="<?php echo $write['training_time4'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>아동학대</th>
                                <td>
                                    <input type="text" name="training_str_date5" id="training_str_date5" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_str_date5'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_end_date5" id="training_end_date5" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_end_date5'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_time5" id="training_time5" class="form_input xp100" value="<?php echo $write['training_time5'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>독감예방</th>
                                <td>
                                    <input type="text" name="training_str_date6" id="training_str_date6" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_str_date6'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_end_date6" id="training_end_date6" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['training_end_date6'] ?>">
                                </td>
                                <td>
                                    <input type="text" name="training_time6" id="training_time6" class="form_input xp100" value="<?php echo $write['training_time6'] ?>">
                                </td>
                            </tr>
                        </tbody>
                    </table>

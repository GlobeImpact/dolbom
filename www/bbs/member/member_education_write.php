...
<div id="layer_popup_content">
    <form id="fregisterform" name="fregisterform" action="" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="layer_popup_form">
            <h4 class="layer_popup_form_tit"><?php echo $set_row['set_tit'] ?></h4>
                ...
                <table class="form_tbl">
                    <tbody>
                        <tr>
                            ...
                            <td class="x420">
                                <div class="flex_row">
                                    <input type="text" name="edu_date" id="edu_date" class="form_input_date date_api" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['edu_date'] ?>">
                            ...
                            <td>
                                <div class="flex_row">
                                    ...
                                    <label class="input_label" for="edu_method<?php echo $l ?>">
                                        <input type="radio" name="edu_method" id="edu_method<?php echo $l ?>" value="<?php echo $set_edu_method_arr[$l] ?>" <?php echo $edu_method_checked ?>><?php echo $set_edu_method_arr[$l] ?>
                                    </label>
                                    <?php
                                    }
                                    ?>
                        ...
                        <tr>
                            <th>교육기관</th>
                            <td>
                                <input type="text" name="edu_agency" id="edu_agency" class="form_input xp100" value="<?php echo $write['edu_agency'] ?>">
                            </td>
                        </tr>
                        <tr>
                            <th class="h333">참석자<br><a class="form_btn1 mtop5" id="form_select_btn">참석자선택</a></th>
                            <td class="h333 valign_top">
                                <div class="mb_select_list_box">
                                    <?php
                                    $edul_sql = " select b.mb_id, b.mb_name, b.service_category from g5_member_education_list as a left join g5_member as b on b.mb_id = a.edul_mb_id where a.idx = '{$idx}' and b.mb_hide = '' ";

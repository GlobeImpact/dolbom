            ...
            <div class="form_tbl_wrap">
                <table class="form_tbl">
                    <tbody>
                        ...
                        <tr>
                            <th>대여기간<span class="required_txt">*</span></th>
                            <td>
                                <div class="td_flex_row">
                                    <input type="text" name="rent_date" id="rent_date" class="form_input_date date_api" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['rent_date'] ?>">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <th>대여자<span class="required_txt">*</span></th>
                            <td>
                                <div class="td_flex_row">
                                    <input type="hidden" name="rent_mb_id" id="rent_mb_id" value="<?php echo $write['rent_mb_id'] ?>">
                                    <input type="text" name="rent_name" id="rent_name" class="form_input_date" value="<?php echo $write['rent_name'] ?>">
                                    <a id="mb_select_btn" class="form_btn1">대여자선택</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="td_flex_row">
                                    <input type="text" name="rent_return_date" id="rent_return_date" class="form_input_date date_api" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['rent_return_date'] ?>">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="td_flex_row">
                                    ...
                                    <input type="text" name="rent_return_name" id="rent_return_name" class="form_input_date" value="<?php echo $write['rent_return_name'] ?>">
                                    <a id="mb_select_btn2" class="form_btn1">반납자선택</a>
                                </div>
                            </td>
                        </tr>
                    </tbody>

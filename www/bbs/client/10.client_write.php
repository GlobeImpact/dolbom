            ...
            <table class="write_tbl">
                <tbody>
                    ...
                    <tr class="client_service_view" client_service="<?php echo ${'set_mn'.$_SESSION['this_code'].'_service_category_arr'}[0] ?>">
                        ...
                        <th>아기생년월일</th>
                        <td>
                            <input type="text" name="cl_baby_birth" id="cl_baby_birth" class="form_input x80" oninput="autoHyphen3(this)" maxlength="10" value="<?php echo $write['cl_baby_birth'] ?>">
                        </td>
                        <th>아기성별</th>
                        <td>
...
<script>
$(function(){
    $("#receipt_date, #str_date, #end_date, #cancel_date, #cl_birth_due_date, #cl_birth_date, #cl_baby_birth, #cl_service_str_date, #cl_service_end_date").datepicker({	// UI 달력을 사용할 Class / Id 를 콤마(,) 로 나누어서 다중으로 가능

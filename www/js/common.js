...
var win_zip = function(frm_name, frm_zip, frm_addr1, frm_addr2, frm_addr3, frm_jibeon) {
    ...
    var complete_fn = function(data, area_x, area_y){
        ...
        if($('#mb_area').length > 0) {
            $('#mb_area').val(data.sido);
            $('#mb_area_x').val(area_x);
            $('#mb_area_y').val(area_y);
        }

        if($('#cl_area').length > 0) {
            $('#cl_area').val(data.sido);
            $('#cl_area_x').val(area_x);
            $('#cl_area_y').val(area_y);
        }
                ...
                oncomplete: function(data) {
                    ...
                    geocoder.addressSearch(data.roadAddress, (result, status) => {
                        if (status === kakao.maps.services.Status.OK) {
                            ...
                            complete_fn(data, area_x, area_y);
                        }
                    });
